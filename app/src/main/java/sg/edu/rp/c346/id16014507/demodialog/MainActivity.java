package sg.edu.rp.c346.id16014507.demodialog;
...
public class MainActivity extends AppCompatActivity {
    Button btnDemo, btnDemo2, btnDemo3, btnExercise3, btnDemo4, btnDemo5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemo3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myBuilder.setTitle("Demo 3-Text Dialog");
        ...
        btnExercise3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Integer sum = Integer.parseInt(etInputNumber1.getText().toString()) +
                                Integer.parseInt(etInputNumber2.getText().toString());
